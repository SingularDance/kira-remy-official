![1786433542683](image/README/1786433542683.png)
...
![1786433719639](image/README/1786433719639.png)

她可以：

- 用 AI 陪你聊天（DeepSeek / 通义千问）
- 根据心情切换表情——开心、生气、委屈、期待，无聊久了还会睡着
- 一起玩 2048、猜拳、掷骰子、星海战棋
- 帮你记笔记、开程序、开书签
- 记住你们的对话，也记得你是谁
- 把图片拖到她身上，她会认真看图、和你聊天
- 偷听你正在放的歌和视频，过一会儿主动搭话
- 一键换壁纸：本地文件夹 + 社区壁纸站在线预览与切换

主角是 **蕾咪**：18 岁，158cm，喜欢慕斯蛋糕和抹茶雪顶拿铁。

![1786433771950](image/README/1786433771950.png)
...
│       ├── game_2048.py     # 2048
│       ├── dice.py          # 掷骰子
│       └── battleship.py    # 星海战棋（LLM 解说 + 开火决策，无 Key 时回退本地 AI）
│
